...
<div>
    ...
    <table class= "table table-dark table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> <a class="btn btn-sm btn-secondary" href="index.php?escolha=agendauser&pagina=<?=$pagina?>&id=<?=$dados['id']?>&statuss=<?=$dados['statuss']?>"><!--trecho do botao do status -->
                    <?php 
                    if($dados["statuss"]==0){
    ...
    echo '<li class="page-item"><a class="page-link" href ="?escolha=agendauser&pagina=1">Primeira Pagina</a></li>';

    if($pagina>3){
        ?>
           <li class="page-item"><a class="page-link" href="?escolha=agendauser&pagina=<?php echo $pagina-1?>"> << </a></li>
        <?php
    ...
    for($i=1;$i<=$paginastotal;$i++){
       ...
       if($i>=($pagina-2) && $i <= ($pagina +2)){
                if($i==$pagina){
                    ...
                    echo "<li class='page-item'><a class='page-link' href=\"?escolha=agendauser&pagina={$i}\"> {$i} </a></li>";
                }
       }
    }
    ...
    echo "<li class='page-item'><a class='page-link' href =\"?escolha=agendauser&pagina=$paginastotal\">Ultima Pagina</a></li>";// navega direto para ultima pagina
